...
// import { uploadToCloudinary } from "../../../util/uploadToCloudnary"; // Not needed - using backend upload
...
const AddProductForm: React.FC<AddProductFormProps> = ({
  ...
  const handleImageChange = async (event: any) => {
    ...
    if (files && files.length > 0) {
      ...
      // Add files to formik values for later FormData creation
      ...
      formik.setFieldValue("images", [...currentImages, ...previewUrls]);
  ...
  const handleRemoveImage = (index: number) => {
    const currentImages = formik.values.images || [];
    const validImages = currentImages.filter((img: any) => img !== null && img !== undefined);
    ...
    if (index >= 0 && index < validImages.length) {
      ...
      formik.setFieldValue("images", validImages);
    }
  };
        ...
        <Grid container spacing={2}>
          <Grid className="flex flex-wrap gap-5" item xs={12}>
            ...
            <div className="flex flex-wrap gap-2">
              {formik.values.images && formik.values.images.filter((imageObj: any) => imageObj !== null && imageObj !== undefined).map((imageObj:any, index:any) => (
          ...
          <Grid item xs={12} sm={6} lg={3}>
            ...
            >
              ...
              {formik.touched.color && formik.errors.color && (
                <FormHelperText>{typeof formik.errors.color === 'string' ? formik.errors.color : ''}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6} lg={3}>
            ...
            >
              ...
              {formik.touched.sizes && formik.errors.sizes && (
                <FormHelperText>{typeof formik.errors.sizes === 'string' ? formik.errors.sizes : ''}</FormHelperText>
              )}
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={6} lg={4}>
            ...
            >
              ...
              {formik.touched.category && formik.errors.category && (
                <FormHelperText>{typeof formik.errors.category === 'string' ? formik.errors.category : ''}</FormHelperText>
              )}
            </FormControl>
          </Grid>
